...
parser.add_argument('-f', '--dictionaryfile', type=str, default=os.path.dirname(os.path.realpath(__file__))+'/usr/local/xkcdpassword/words.txt', help='Absolute path to an alternative dictionary', action='store')
...
def main():
	...
	fn = '/usr/local/xkcdpassword/oldwords.txt' if args.oldwords else args.args.dictionaryfile
